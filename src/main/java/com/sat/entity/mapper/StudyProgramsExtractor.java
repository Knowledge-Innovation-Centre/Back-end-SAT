 ...
 * @author Dean
 */
public class StudyProgramsExtractor implements ResultSetExtractor<List<StudyProgram>>  {

    @Override
    public List<StudyProgram> extractData(ResultSet rs) throws SQLException, DataAccessException {
        StudyProgram p = null;
        StudyModule m = null;
        ...
        Hashtable<Integer, StudyProgram> hash = new Hashtable<Integer, StudyProgram>();
        // XX.id, XX.study_program_id, XX.name, XX.description
        ...
        List<StudyProgram> ret=new ArrayList<StudyProgram>();
        Enumeration enu=hash.elements();
        while(enu.hasMoreElements()){
            ret.add((StudyProgram)enu.nextElement());
        }
